...
<div>
    <center>
        <br>
        <span style="font-size: 30px;color:brown;font-style: normal;"> UnBlock Employee </span>
        <br><br>
       ...
       <%
               ...
               if(db.rst.next()){
                  ...
                  out.println("<form action=UnBlock>");
                  ...
                  out.println("<tr><td width='300'><input type='submit' value='UnBlock'></td><td><input type='reset' value='Reset'></td></tr>");
