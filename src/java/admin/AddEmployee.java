...
public class AddEmployee extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           admin.DBConnection db = new admin.DBConnection();
           db.pstmt = db.con.prepareStatement("insert into emp_mstr(ecode,ename,edob,egender,epost,eaddr,ecity,econt,email,idname,idno,pswd)values(?,?,?,?,?,?,?,?,?,?,?,?)");
