<%-- 
    Document   : home.jsp
    Created on : 7 Mar, 2024, 6:03:31 PM
    Author     : shiva
--%>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><a href="home.jsp"><span>OFFICE MANAGER (Home)</span></a></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav" style="width:1300px; ">
        <ul>
          ...
          <li><a href="Services.jsp"><span>Our Services</span></a></li>
      ...
      <div class="clr"></div>
      <div class="slider" >
        <div id="coin-slider"> <a href="ImgOffice.jsp"><img src="images/slide1.jpg" width="960" height="360" alt="" /></a> <a href="#"><img src="images/om5.jpg" width="960" height="360" alt="" /></a> <a href="#"><img src="images/slide2.jpg" width="960" height="360" alt="" /> </a><a href="#"><img src="images/slide3.jpg" width="960" height="360" alt="" /> </a> <a href="#"><img src="images/om.jpg" width="960" height="360" alt="" /></a><a href="#"><img src="images/om2.jpg" width="960" height="360" alt="" /></a><a href="#"><img src="images/om3.jpg" width="960" height="360" alt="" /></a><a href="#"><img src="images/om4.jpg" width="960" height="360" alt="" /></a></div>
       <div class="clr"></div>
      </div>
      <div class="clr"></div>
    </div>
  ...
  <div class="fbg">
    <div class="fbg_resize">
      ...
      <div class="col c3">
        ...
        <p></p>
        <p class="contact_info"> <span>Address:IET_RMLAU,Ayodhya </span> 
          
          <span></span> <br />
          <span>Contact: 6387190768</span> <br /><br>
          <span>E-mail: shivamyadav343343@gmail.com</span> <a href="#"></a> </p>
      </div>
      <div class="clr"></div>
    </div>
  </div>
